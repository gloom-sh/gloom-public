...
/**
 * Reads accounts and holdings for one Public API secret.
 *
 * The secret is exchanged for an access token that Public only honours for five
 * minutes, and nothing here can place an order: every call after the exchange
 * is a GET against a reporting endpoint.
 */
